...
#(
    ...
    logic [                      3:0] lz_16count_0, lz_16count_1;
    logic [                      2:0] lz_8count_0, lz_8count_1, lz_8count_2, lz_8count_3;
    logic [                      3:0] lo_16count_0, lo_16count_1;
    logic [                      2:0] lo_8count_0, lo_8count_1, lo_8count_2, lo_8count_3;
    logic [                      3:0] ls_16count_0, ls_16count_1;
    logic [                      2:0] ls_8count_0, ls_8count_1, ls_8count_2, ls_8count_3;
    logic lz_tz_empty, lz_tz_wempty, lz_16empty_0, lz_16empty_1, lz_8empty_0, lz_8empty_1, lz_8empty_2, lz_8empty_3;
    logic lo_16empty_0, lo_16empty_1, lo_8empty_0, lo_8empty_1, lo_8empty_2, lo_8empty_3;
    logic ls_16empty_0, ls_16empty_1, ls_8empty_0, ls_8empty_1, ls_8empty_2, ls_8empty_3;
    riscv::xlen_t orcbw_result, rev8w_result, clz16b_result, clz8b_result, clo16b_result, clo8b_result, clrs16b_result, clrs8b_result;
    ...
    always_comb begin
        ...
        if (ariane_pkg::BITMANIP) begin
            unique case (fu_data_i.operation)
                ...
                ADDUW, CPOPW, CLZW, CLZ16, CLZ8, CLO16, CLO8, CLRS16, CLRS8: operand_a_bitmanip = fu_data_i.operand_a[31:0];
                default:            ;
            endcase
        end
    end
    ...
    logic [7:0]   simd_abs_result8_1, simd_abs_result8_2, simd_abs_result8_3, simd_abs_result8_4; // SIMD 8 bits absolute value results
    logic [15:0]  simd_abs_result16_1, simd_abs_result16_2; // SIMD 16 bits absolute value results
    logic [31:0]  simd_abs_result;
    logic is_16bits;

    always_comb begin
    unique case (fu_data_i.operation)
            //SIMD 8 bits absolute value
            KABS8: begin
                simd_abs_result8_1 = (fu_data_i.operand_a[7:0] == 8'h80) ? 8'h7f : (fu_data_i.operand_a[7]== 1'b1) ? ~fu_data_i.operand_a[7:0]+1 : fu_data_i.operand_a[7:0];
                simd_abs_result8_2 = (fu_data_i.operand_a[15:8] == 8'h80) ? 8'h7f : (fu_data_i.operand_a[15]== 1'b1) ? ~fu_data_i.operand_a[15:8]+1 : fu_data_i.operand_a[15:8];
                simd_abs_result8_3 = (fu_data_i.operand_a[23:16] == 8'h80) ? 8'h7f : (fu_data_i.operand_a[23]== 1'b1) ? ~fu_data_i.operand_a[23:16]+1 : fu_data_i.operand_a[23:16];
                simd_abs_result8_4 = (fu_data_i.operand_a[31:24] == 8'h80) ? 8'h7f : (fu_data_i.operand_a[31]== 1'b1) ? ~fu_data_i.operand_a[31:24]+1 : fu_data_i.operand_a[31:24];
                simd_abs_result = {simd_abs_result8_4, simd_abs_result8_3, simd_abs_result8_2, simd_abs_result8_1};
            end
            //SIMD 16 bits absolute value
            KABS16: begin
                simd_abs_result16_1 = (fu_data_i.operand_a[15:0] == 16'h8000) ? 16'h7fff : (fu_data_i.operand_a[15]== 1'b1) ? ~fu_data_i.operand_a[15:0]+1 : fu_data_i.operand_a[15:0];
                simd_abs_result16_2 = (fu_data_i.operand_a[31:16] == 16'h8000) ? 16'h7fff : (fu_data_i.operand_a[31]== 1'b1) ? ~fu_data_i.operand_a[31:16]+1 : fu_data_i.operand_a[31:16];
                simd_abs_result = {simd_abs_result16_2, simd_abs_result16_1};
            end
            default: ;
        endcase
    end
    ...
    // -----------
    // SMID swap instructions
    // -----------

    logic [31:0]   simd_swap_result; // SIMD swap final result
    logic [7:0]    temp8_1, temp8_2, temp8_3, temp8_4;
    logic [15:0]   temp16_1, temp16_2;

    always_comb begin
        unique case (fu_data_i.operation)
            //SIMD 8 bits swap
            SWAP8: begin
                temp8_1 = fu_data_i.operand_a[7:0];
                temp8_2 = fu_data_i.operand_a[15:8];
                temp8_3 = fu_data_i.operand_a[23:16];
                temp8_4 = fu_data_i.operand_a[31:24];
                simd_swap_result = {temp8_3, temp8_4, temp8_1, temp8_2};
            end
            //SIMD 16 bits swap
            SWAP16: begin
                temp16_1 = fu_data_i.operand_a[15:0];
                temp16_2 = fu_data_i.operand_a[31:16];
                simd_swap_result = {temp16_1, temp16_2};
            end
            default: ;
        endcase
    end
    ...
    if (ariane_pkg::BITMANIP) begin : gen_bitmanip
        ...
        .MODE (1)
            ...
            .in_i(operand_a_bitmanip[15:0]),
            .cnt_o(lz_16count_0),
            .empty_o(lz_16empty_0)
        );
        lzc #(
        .WIDTH(16),
        .MODE (1)
        ...
        //Count Leading Signe
        //16b
        logic [14:0] cls_16b_0_input, cls_16b_1_input;
        logic [6:0] cls_8b_0_input, cls_8b_1_input, cls_8b_2_input, cls_8b_3_input;
        assign cls_16b_0_input = operand_a_bitmanip[15] ? ~operand_a_bitmanip[14:0] : operand_a_bitmanip[14:0];
        assign cls_16b_1_input = operand_a_bitmanip[31] ? ~operand_a_bitmanip[30:16] : operand_a_bitmanip[30:16];
        assign cls_8b_0_input = operand_a_bitmanip[7] ? ~operand_a_bitmanip[6:0] : operand_a_bitmanip[6:0];
        assign cls_8b_1_input = operand_a_bitmanip[15] ? ~operand_a_bitmanip[14:8] : operand_a_bitmanip[14:8];
        assign cls_8b_2_input = operand_a_bitmanip[23] ? ~operand_a_bitmanip[22:16] : operand_a_bitmanip[22:16];
        assign cls_8b_3_input = operand_a_bitmanip[31] ? ~operand_a_bitmanip[30:24] : operand_a_bitmanip[30:24];

        lzc #(
        .WIDTH(15),
        .MODE (1)
        ) i_cls_16b_0 (
            .in_i(cls_16b_0_input),
            .cnt_o(cls_16count_0),
            .empty_o(cls_16empty_0)
        );
        ...
        .MODE (1)
            ...
            .in_i(cls_16b_1_input),
            .cnt_o(cls_16count_1),
            .empty_o(cls_16empty_1)
        );
        //8b
        lzc #(
        .WIDTH(7),
    ...
    always_comb begin
        ...
        if (ariane_pkg::BITMANIP) begin
            ...
            unique case (fu_data_i.operation)
                ...
                CLZ16: result_o = { 
                                ((lz_16empty_1) ? 16'd16 : {12'b0, lz_16count_1}),
                                ((lz_16empty_0) ? 16'd16 : {12'b0, lz_16count_0})
                                };
                CLZ8: result_o = {
                                ((lz_8empty_3) ? 8'd8 : {5'b0, lz_8count_3}),
                                ((lz_8empty_2) ? 8'd8 : {5'b0, lz_8count_2}),
                                ((lz_8empty_1) ? 8'd8 : {5'b0, lz_8count_1}),
                                ((lz_8empty_0) ? 8'd8 : {5'b0, lz_8count_0})
                                };

                // Count Leading Ones
                CLO16: result_o = {
                                ((lo_16empty_1) ? 16'd16 : {12'b0, lo_16count_1}), 
                                ((lo_16empty_0) ? 16'd16 : {12'b0, lo_16count_0})
                                };
                CLO8: result_o = {
                                ((lo_8empty_3) ? 8'd8 : {5'b0, lo_8count_3}),
                                ((lo_8empty_2) ? 8'd8 : {5'b0, lo_8count_2}),
                                ((lo_8empty_1) ? 8'd8 : {5'b0, lo_8count_1}),
                                ((lo_8empty_0) ? 8'd8 : {5'b0, lo_8count_0})
                                };

                // Count Leading Signed
                CLRS16: result_o = {
                                ((ls_16empty_1) ? 16'd16 : {12'b0, ls_16count_1}),
                                ((ls_16empty_0) ? 16'd16 : {12'b0, ls_16count_0})
                                };
                CLRS8: result_o = {
                                ((ls_8empty_3) ? 8'd8 : {5'b0, ls_8count_3}),
                                ((ls_8empty_2) ? 8'd8 : {5'b0, ls_8count_2}),
                                ((ls_8empty_1) ? 8'd8 : {5'b0, ls_8count_1}),
                                ((ls_8empty_0) ? 8'd8 : {5'b0, ls_8count_0})
                                };
