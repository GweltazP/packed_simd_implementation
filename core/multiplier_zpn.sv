...
#(
  ...
  assign mult_valid      = mult_valid_i && (operation_i inside {MUL, MULH, MULHU, MULHSU, MULW, CLMUL, CLMULH, CLMULR,
                                                                KHM16, KHMX16,     //CHANGED: added for SIMD
                                                                KHM8, KHMX8});        //CHANGED: added for SIMD
  ...
  always_comb begin
    ...
    if (operation_i == KHM16 | operation_i == KHMX16) begin
        simd_16bit = 1'b1;
    ...
    end if (operation_i == KHMX16 | 
            operation_i == KHMX8) begin
        crossed = 1'b1;
    ...
    // signed multiplication
            ...
            operation_i == KHM16 | operation_i == KHMX16 | 
            operation_i == KHM8 | operation_i == KHMX8) begin
      sign_a = 1'b1;
      sign_b = 1'b1;
